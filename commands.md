...
| customcommand | Manage custom commands for the server. | Utility | customcmd | search, help, list, set, delete |
...
| random | Commands that generate random data. | Utility | rand | dice, text, card, coin, number, choice |
