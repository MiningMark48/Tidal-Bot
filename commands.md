...
| birthday | Allows users to set their birthdays | Birthdays | bday | set, get, del |
...
| reactor | Reactor allows users to react to a message to get assigned a specific role. | Server Management | reactionroles | get, clearall, add, delete |
