...
| clear | Clear the queue without stopping the bot. | Music | N/A |
...
| info | Retrieve various Node/Server/Player information. | Music | N/A |
...
| pause | Pause the currently playing track. | Music | N/A |
...
| reactcontrol | Dummy command for error handling in our player. | Music | N/A |
...
| repeat | Repeat the currently playing track. | Music | N/A |
| restart | Restart the currently playing track. | Music | N/A |
| resume | Resume a currently paused track. | Music | N/A |
...
| seteq | Set the equalizer.  Types: flat (f) [default], boost (b), metal (m), piano (p) | Music | eq, equalizer, setequalizer |
...
| skip | Skip the current track. | Music | N/A |
...
| stop | Stop the player, disconnect and clear the queue. | Music | N/A |
...
| vol_down | None | Music | N/A |
| vol_up | None | Music | N/A |
