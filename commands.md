...
| cashapp | Help support development via CashApp | Support | N/A |
...
| joinmessage | (Group) Join message is a message to be sent to a user when they join the server. | Server Management | joinmsg |
...
| random | (Group) Commands that generate random data. | Utility | rand |
| reactor | (Group) Reactor allows users to react to a message to get assigned a specific role.  Note: This feature is experimental and susceptible to faults. | Server Management | reactionroles |
...
| thread | (Group) Channel Threads, until added officially by Discord  Note: This is experimental, use with caution! | Utility | threads |
