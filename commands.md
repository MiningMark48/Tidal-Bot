...
| customcommand | Manage custom commands for the server. | Utility | customcmd | help, delete, search, set, list |
...
| random | Commands that generate random data. | Utility | rand | number, choice, dice, text, card, coin |
| reactor | Reactor allows users to react to a message to get assigned a specific role.  Note: This feature is experimental and susceptible to faults. | Server Management | reactionroles | clearall, get, add, delete |
