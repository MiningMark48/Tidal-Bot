...
| customcommand | Manage custom commands for the server. | Utility | customcmd | delete, list, set |
...
| random | Commands that generate random data. | Utility | rand | choice, dice, text, card, coin, number |
